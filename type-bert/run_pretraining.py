...
flags.DEFINE_integer('num_steps_per_epoch', 10000,
                     'Total number of training steps to run per epoch.')
flags.DEFINE_float('warmup_steps', 10000,
                   'Warmup steps for Adam weight decay optimizer.')
flags.DEFINE_bool('use_next_sentence_label', False,
...
class TokenCallback(keras.callbacks.Callback):
...
def main(_):
  ...
  custom_callbacks = [TokenCallback()]
  custom_callbacks = []
  run_bert_pretrain(strategy, custom_callbacks)

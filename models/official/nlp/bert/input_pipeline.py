...
def create_classifier_dataset(file_path,
  ...
  if not is_training:
    name_to_features['best_context'] = tf.io.FixedLenFeature([seq_length], label_type)
    name_to_features['is_user_def'] = tf.io.FixedLenFeature([seq_length], label_type)
    name_to_features['filename'] = tf.io.FixedLenFeature([1], label_type)
  ...
  def _select_data_from_record(record):
    ...
    # bc = record['best_context']
      user_def = record['is_user_def']
      filename = record['filename']
      return (x, y, user_def, filename)
